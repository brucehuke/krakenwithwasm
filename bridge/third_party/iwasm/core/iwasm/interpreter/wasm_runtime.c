...
{
    uint32 i;
    //printf("wasm_runtime_lookup_function count:%d  name:%s\n",module_inst->export_func_count,name);
    //fflush(stdout);
    for (i = 0; i < module_inst->export_func_count; i++)
    {
        //printf("wasm_runtime_lookup_function loop:%d  name:%s\n",i,module_inst->export_functions[i].name);
        //fflush(stdout);
